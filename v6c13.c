...
enum{ARG_NAME, ARG_INPUT, ARG_OUTPUT, ARG_DUR, ARG_GRAINDUR, ARGC};
...
int main(int argc, char *argv[])
{
	...
	grain_duration = atof(argv[ARG_GRAINDUR]);
	...
	for(totalDur = 0.0f; totalDur < duration; totalDur += grain_duration)
	{
